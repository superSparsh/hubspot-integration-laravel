    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    <h1 class="h3 fw-bold mb-1">Tittu Message Automation Setup Guide</h1>
                    <p class="text-muted mb-0">Learn how to install, configure, and use the Tittu Message Automation
                        integration.</p>
                </div>
            ...
            <div class="card-modern mb-5">
                <div class="mb-4">
                    <p class="text-muted">
                        Tittu Message Automation allows you to send automated WhatsApp messages based on HubSpot events.
                        Typical use cases
                        include:
                    </p>
                    <ul class="text-muted">
                ...
                <div class="mb-4">
                    <p class="text-muted mb-3">
                        Follow these steps to connect Tittu Message Automation to your HubSpot account:
                    </p>
                    <ol class="text-muted mb-0">
                        <li class="mb-2">Click the <strong>"Connect HubSpot Account"</strong> button on the Tittu Message
                            Automation home
                            page.</li>
                        ...
                        <li class="mb-2">Review the requested permissions (Contacts, Deals) and click <strong>Connect
                                app</strong>.</li>
                        <li class="mb-2">You will be redirected back to the Tittu Message Automation dashboard to complete
                            the login
                            process.</li>
                    </ol>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <ol class="text-muted mb-0">
                        <li class="mb-2">Log in to your Tittu Message Automation dashboard.</li>
                ...
                <div class="mb-4">
                    <p class="text-muted">
                        ...
                        Contact is created), Tittu Message Automation will automatically send the corresponding WhatsApp
                        message to the
                        contact's phone number.
                    </p>
                    <p class="text-muted">
                        You can view logs of all sent messages in the Tittu Message Automation <strong>Logs</strong>
                        section.
                    </p>
                </div>
                ...
                <div class="mb-4">
                    <p class="text-muted">
                        To stop using Tittu Message Automation and disconnect your account:
                    </p>
                    <ol class="text-muted mb-0">
                        <li class="mb-2"><strong>Log in</strong> to your Tittu Message Automation dashboard.</li>
