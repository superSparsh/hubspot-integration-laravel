...
<head>
    ...
    <title>Edit Trigger · WAPAPP for HubSpot</title>
            ...
            <div class="trigger-card-header">
                <div>
                    ...
                    <p class="trigger-card-subtitle">
                        Update your HubSpot event mapping and WhatsApp template for this trigger.
                    </p>
                </div>
                ...
                <div class="form-layout">
                    ...
                    <div class="section-card">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="event" id="event_input"
                                value="{{ old('event', $trigger->event) }}" required>
...
Select an event type to view sample payload...
    ...
    <script>
        ...
        // Initialize event selection from existing trigger
